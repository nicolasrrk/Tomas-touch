...
window.TS = {
  ...
  delWork: Orders.delWork, addOrderCost: Orders.addOrderCost, delOrderCost: Orders.delOrderCost,
  updateCost: Orders.updateCost, updateDeposit: Orders.updateDeposit,
  updateClientInfo: Orders.updateClientInfo,
  updatePickupDeadline: Orders.updatePickupDeadline, updateWarranty: Orders.updateWarranty,
  ...
  setOrdersStatusFilter: Orders.setStatusFilter,
